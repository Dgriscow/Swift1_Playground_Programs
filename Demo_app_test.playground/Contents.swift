...
class BuyAPrius {
    ...
    func calculatePrice() -> String{
        ...
        if self.model == 1{
            ...
            self.finalEngine = "1.8Cyl-4L AWD-e"
            self.packages = "Standard"
            
            if self.colorEXT != "Eletric Storm Blue" || self.colorEXT != "Supersonic Red" || self.colorEXT != "Wind Chill Pearl" || self.colorEXT != "Midnight Black Metallic" || self.colorEXT != "Sea Glass Pearl"{
            ...
            if self.colorINT != "Black Fabric" || self.colorINT != "MoonStone Fabric" || self.colorINT != "Harvest Beige Fabric"{
            ...
            if self.colorINT != "Black Fabric" || self.colorINT != "MoonStone Fabric" || self.colorINT != "Harvest Beige Softex"{
                print(" \(self.colorINT) Error")
                self.colorINT = "STANDARD"
            } else {
                for color2 in colorsINTOptions.keys{
            ...
            if self.colorEXT != "Classic Silver Metallic" || self.colorEXT != "White" ||  self.colorEXT != "Midnight Black Metallic"{
                print(" \(self.colorEXT) Error")
                self.colorEXT = "STANDARD"
            } else {
                for color in colorsEXTOptions.keys{
        ...
        return "Your cars total is: $\(self.totalcost), The \(self.finalModel) with a \(self.finalEngine) and the \(self.packages!) with a exterior color of \(self.colorEXT) with an interior color of \(self.colorINT) with the selected accessories \(self.accessories!))"
    }
